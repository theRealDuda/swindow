...
from LineDialog import CircleDialog
from FrameDialog import GaussianDialog
...
BASE_FRAMED_IMAGE_NAME = 'framed.png'
BASE_GREEN_LINE_IMAGE_NAME = 'green_line.png'
...
class UiMainWindow(object):
    ...
    def translate_ui(self):
        ...
        self.actionGaussianBlur.setText(_translate("MainWindow", "Add a frame"))
        self.actionGaussianBlur.setStatusTip(_translate("MainWindow", "Show the blurred image"))
        self.actionGaussianBlur.setShortcut(_translate("MainWindow", "Alt+2"))

        self.actionRedCircle.setText(_translate("MainWindow", "Add green line"))
        self.actionRedCircle.setStatusTip(_translate("MainWindow", "Add the green line on the image"))
    ...
    def open_red_circle_dialog(self):
        ...
        if dialog.exec_():
            ...
            param4 = dialog.param4.text()
            param5 = dialog.param5.text()
    ...
    def add_red_circle(self):
        ...
        try:
            ...
            image_with_red_circle = cv.line(image, pt1=(params[0], params[1]), pt2=(params[2],params[3]),
                                            color=(0, 255, 0),
                                            thickness=params[4])

            cv.imwrite(f'{BASE_IMAGES_DIR}{BASE_GREEN_LINE_IMAGE_NAME}', image_with_red_circle)
            self.set_absolute_path_from_relative(f'{BASE_IMAGES_DIR}{BASE_GREEN_LINE_IMAGE_NAME}')
    ...
    def gaussian_blur(self):
        ...
        try:
            ...
            img_blur = cv.copyMakeBorder(image,
                                         top=param,
                                         bottom=param,
                                         left=param,
                                         right=param,
            ...
            cv.imwrite(f'{BASE_IMAGES_DIR}{BASE_FRAMED_IMAGE_NAME}', img_blur)
            self.set_absolute_path_from_relative(f'{BASE_IMAGES_DIR}{BASE_FRAMED_IMAGE_NAME}')
            self.label.setPixmap(QPixmap(self.file_name[0]))
        except Exception as e:
            self.label_text.clear()
            self.show_error_message("Please, choose the image")
